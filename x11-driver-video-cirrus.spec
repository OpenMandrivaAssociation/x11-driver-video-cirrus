...
# git-archive --format=tar --prefix=xf86-video-cirrus-1.1.0/ xf86-video-cirrus-1.1.1@mandriva | bzip2 -9 > xf86-video-cirrus-1.1.0.tar.bz2
########################################################################
Source0: xf86-video-cirrus-%{version}.tar.bz2
License: MIT
########################################################################
# git-format-patch xf86-video-cirrus-1.1.1@mandriva..origin/mandriva+gpl
